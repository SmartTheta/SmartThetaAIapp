    ...
    return (
        <div className="w-full bg-slate-950 py-20 overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center h-[400px]">

                    {/* Left: Data Input */}
                    <div className="relative h-full flex flex-col justify-center items-center md:items-end pr-8 border-r border-slate-800/50">
                        <div className="text-slate-500 text-sm mb-8 font-mono tracking-widest uppercase">Raw Market Data</div>
                        <div className="relative w-32 h-64 flex flex-col justify-center gap-4">
                    ...
                    <div className="relative flex justify-center items-center">
                        ...
                        <div className="relative w-48 h-48">
                            ...
                            <motion.div
                                ...
                                className="absolute inset-4 rounded-full border border-cyan-500/30 border-dotted"
                            />
                            ...
                            <motion.div
                                ...
                                className="absolute inset-12 rounded-full bg-gradient-to-br from-blue-600 to-cyan-400 shadow-[0_0_50px_rgba(59,130,246,0.5)] flex items-center justify-center"
                            >
                    ...
                    <div className="relative h-full flex flex-col justify-center items-center md:items-start pl-8 border-l border-slate-800/50">
                        <div className="text-slate-500 text-sm mb-8 font-mono tracking-widest uppercase">Actionable Insights</div>
                        <div className="relative w-48 h-64 flex flex-col justify-center gap-6">
